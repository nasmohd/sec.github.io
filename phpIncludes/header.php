                            ...
                            <div class='container-fluid'><button data-toggle='collapse' class='navbar-toggler' data-target='#navcol-1'><span class='sr-only'>Toggle navigation</span><span class='navbar-toggler-icon'></span></button>
                                <div class='collapse navbar-collapse' id='navcol-1' style="font-size:15px;">
                                    <ul class='nav navbar-nav'>
                                        ...
                                        <a class='nav-link active ml-lg-4' href='../pages/Home.php'>Profile</a>
                                        </li>
                                        <li class='nav-item ml-lg-5' role='presentation' id='head_txt'>
                                            <div class='nav-item dropdown mt-2'>
                                               <a class='dropdown-toggle active' data-toggle='dropdown' aria-expanded='false' href='../pages/Syllabus.php' style='color:black;' onclick="clear_local()" id="header_link">Syllabus</a>
                                       ...
                                       <div class='nav-item dropdown mt-2 ml-lg-5'>
                                           <a class='dropdown-toggle active' data-toggle='dropdown' aria-expanded='false' href='../pages/Syllabus.php' style='color:black;' id="header_link">Recommended books</a>
                                            <div class='dropdown-menu' role='menu' style="font-size:14px;">
                                                <a class='dropdown-item' role='presentation' href='rec_olevel.php' onclick="clear_local()">O Level</a>
                                                <a class='dropdown-item' role='presentation' href='rec_alevel.php' onclick="clear_local()">A Level</a>
                                            </div>
                                        </div>
                                        </li>
                                        ...
                                        <li class='nav-item' role='presentation'><a class='nav-link active ml-lg-4' id='head_txt' href='../pages/Timetable_Templates.php'>Study Timetable</a></li>
