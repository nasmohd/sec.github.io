                            ...
                            <div class='container-fluid'><button data-toggle='collapse' class='navbar-toggler' data-target='#navcol-1'><span class='sr-only'>Toggle navigation</span><span class='navbar-toggler-icon'></span></button>
                                <div class='collapse navbar-collapse' id='navcol-1'>
                                    <ul class='nav navbar-nav'>
                                        <li class='nav-item' role='presentation'><a class='nav-link active ml-lg-4' id='head_txt' href='../pages/Home.php'>Home</a></li>
                                        <li class='nav-item ml-lg-5' role='presentation' id='head_txt'>
                                            <div class='nav-item dropdown mt-2'><a class='dropdown-toggle active' data-toggle='dropdown' aria-expanded='false' href='../pages/Syllabus.php' style='color:black;'>Syllabus</a>
...
-->
                                    ...
                                    </ul><a class='ml-lg-5' href='../phpIncludes/logout.inc.php'><strong>Logout</strong></a></div>
                            </div>
                        </nav>
                    </div>
                </div>
