...
<!--                        <h1 class="text-center my-4" style="font-size: 30px;">Secondary School Syllabus Guider</h1>-->
    ...
    <div>
        <div class="container">
           <form action="phpIncludes/reg.inc.php" method="post">
            <div class="row mt-lg-5 mb-lg-5 mt-2">
                <div class="col mb-5">
                    <div class="col-12 col-lg-4 ml-auto mr-auto py-2" style="background-color:#0C7FCF; color:white; border-top-left-radius: 10px;  border-top-right-radius: 10px;">
                        <h1 class="text-center pt-3" style="font-size: 18px;">REGISTER</h1>
                    </div>
                    <div class="col-12 col-lg-4 ml-auto mr-auto pb-3 pt-2" style="border:2px solid #449EFF; border-bottom-left-radius:10px; border-bottom-right-radius:10px;">
                        <div class="col-lg-11 col-12 ml-auto mr-auto pb-2">              
                           <div class="row"><input type="text" id="regNo" class="col-5 mt-3 ml-lg-3 mr-lg-1 form-control" placeholder="First Name" name="FirstName" value="Festus">
                           <input type="text" class="col-5 mt-3 ml-lg-3 form-control" placeholder="Last Name" name="LastName" value="Maiga"></div>
                           <input type="text" id="regNo" class="col-12 mt-3 ml-auto mr-auto form-control" placeholder="Username" name="Username" value="fmaiga">
                           <input type="number" id="pwd" class="col-12 mt-2 ml-auto mr-auto form-control" placeholder="Phone Number" name="PhoneNumber" value="">
                           <input type="number" id="pwd" class="col-12 mt-2 ml-auto mr-auto form-control" placeholder="Parent Phone Number" name="P_PhoneNumber" value="">
                           <div class="row">
                           <input type="text" class="col-5 mt-2 form-control ml-lg-3 mr-lg-1" placeholder="Form" name="form" value="">
                           <input type="text"  class="col-5 mt-2 form-control ml-lg-3" placeholder="Combination" name="combination" value="" style="font-size:16px;"></div>
                           <input type="text" id="pwd" class="col-12 mt-2 ml-auto mr-auto form-control" placeholder="Password" name="pwd" value="fmaiga">
                            <button
                                class="btn btn-primary col-12 ml-auto mr-auto mt-3 form-control" type="submit" name="register">Sign Up</button>
